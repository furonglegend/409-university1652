...
transform_train_list = [
    ...
    # 移除 transforms.RandomRotation(30)  # <-- 删除这一行
    transforms.ToTensor(),
            ...
            for data, data2, data3, data4 in zip(dataloaders['satellite'], dataloaders['street'], dataloaders['drone'],
                ...
                if opt.views == 2:
                    ...
                    if return_feature:
                        ...
                        if opt.circle:
                            if opt.loss_merge:
                                loss += 1.5*criterion_circle(*convert_label_to_similarity(ff_all, labels_all)) / now_batch_size
                            else:
                        ...
                        if opt.triplet:
                            if opt.loss_merge:
                                ...
                                loss += 1.5*criterion_triplet(ff_all, labels_all, hard_pairs_all)
                            else:
